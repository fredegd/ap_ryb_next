  ...
  return (
    <section id="about" className="bg-background py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-primary mb-12 text-center uppercase">{name}</h2>
        {slogan && (
          <h3 className="text-2xl font-bold text-foreground mb-8 text-center uppercase">{slogan}</h3>
        )}
